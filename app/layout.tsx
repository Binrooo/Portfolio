...
export const metadata: Metadata = {
	title: 'Robin John Roa - Developer',
	description:
	...
	authors: [{ name: 'Robin John Roa' }],
	creator: 'Robin John Roa',
	openGraph: {
		title: 'Robin John Roa - Developer Portfolio',
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: 'Robin John Roa - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
